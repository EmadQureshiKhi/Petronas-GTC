    ...
    <section className="py-20 md:py-32 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          >
            Experience the difference of working with a trusted technology partner. Let's discuss how our services can help transform your business operations and drive sustainable growth.
          </motion.p>
